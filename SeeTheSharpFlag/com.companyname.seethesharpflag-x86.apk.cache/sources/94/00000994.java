...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public NavigationMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        setOrientation(0);
        LayoutInflater.from(context).inflate(C0492R.layout.design_navigation_menu_item, (ViewGroup) this, true);
        setIconSize(context.getResources().getDimensionPixelSize(C0492R.dimen.design_navigation_icon_size));
        CheckedTextView checkedTextView = (CheckedTextView) findViewById(C0492R.C0495id.design_menu_item_text);
    ...
    private void setActionView(View view) {
        if (view != null) {
            if (this.actionArea == null) {
                this.actionArea = (FrameLayout) ((ViewStub) findViewById(C0492R.C0495id.design_menu_item_action_area_stub)).inflate();
            }
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (getContext().getTheme().resolveAttribute(C0034R.attr.colorControlHighlight, typedValue, true)) {
    ...
    public void setIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            if (this.emptyDrawable == null) {
                Drawable drawable2 = ResourcesCompat.getDrawable(getResources(), C0492R.C0494drawable.navigation_empty_icon, getContext().getTheme());
