...
import androidx.cardview.C0160R;
...
public class CardView extends FrameLayout {
    ...
    public CardView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0160R.attr.cardViewStyle);
    }
    ...
    public CardView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0160R.styleable.CardView, i, C0160R.style.CardView);
        if (obtainStyledAttributes.hasValue(C0160R.styleable.CardView_cardBackgroundColor)) {
            valueOf = obtainStyledAttributes.getColorStateList(C0160R.styleable.CardView_cardBackgroundColor);
        } else {
            ...
            if (fArr[2] > 0.5f) {
                color = getResources().getColor(C0160R.C0161color.cardview_light_background);
            } else {
                color = getResources().getColor(C0160R.C0161color.cardview_dark_background);
            }
        ...
        rect.left = obtainStyledAttributes.getDimensionPixelSize(C0160R.styleable.CardView_contentPaddingLeft, dimensionPixelSize);
        rect.top = obtainStyledAttributes.getDimensionPixelSize(C0160R.styleable.CardView_contentPaddingTop, dimensionPixelSize);
        rect.right = obtainStyledAttributes.getDimensionPixelSize(C0160R.styleable.CardView_contentPaddingRight, dimensionPixelSize);
        rect.bottom = obtainStyledAttributes.getDimensionPixelSize(C0160R.styleable.CardView_contentPaddingBottom, dimensionPixelSize);
        float f = dimension2 > dimension3 ? dimension2 : dimension3;
        this.mUserSetMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0160R.styleable.CardView_android_minWidth, 0);
        this.mUserSetMinHeight = obtainStyledAttributes.getDimensionPixelSize(C0160R.styleable.CardView_android_minHeight, 0);
