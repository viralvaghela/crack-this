...
import androidx.fragment.C0240R;
...
public class FragmentAnim {
    ...
    public static AnimationOrAnimator loadAnimation(Context context, FragmentContainer fragmentContainer, Fragment fragment, boolean z) {
        ...
        if (onFindViewById != null && onFindViewById.getTag(C0240R.C0243id.visible_removing_fragment_view_tag) != null) {
            onFindViewById.setTag(C0240R.C0243id.visible_removing_fragment_view_tag, null);
        }
    ...
    private static int transitToAnimResourceId(int i, boolean z) {
        if (i == 4097) {
            return z ? C0240R.anim.fragment_open_enter : C0240R.anim.fragment_open_exit;
        } else if (i == 4099) {
            return z ? C0240R.anim.fragment_fade_enter : C0240R.anim.fragment_fade_exit;
        } else if (i != 8194) {
            return -1;
        } else {
            return z ? C0240R.anim.fragment_close_enter : C0240R.anim.fragment_close_exit;
        }
    }
