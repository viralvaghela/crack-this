...
public final class IndicatorViewController {
    ...
    public IndicatorViewController(TextInputLayout textInputLayout) {
        ...
        this.captionTranslationYPx = context.getResources().getDimensionPixelSize(C0492R.dimen.design_textinput_caption_translate_y);
    }
    ...
    public void setErrorEnabled(boolean z) {
        ...
        if (z) {
            ...
            appCompatTextView.setId(C0492R.C0495id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean z) {
        ...
        if (z) {
            ...
            appCompatTextView.setId(C0492R.C0495id.textinput_helper_text);
            if (Build.VERSION.SDK_INT >= 17) {
