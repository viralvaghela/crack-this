...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        sceneChangeSetup(sceneRoot, mo16clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo16clone);
    }
    ...
    /* renamed from: go */
    public static void m1go(Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* renamed from: go */
    public static void m0go(Scene scene, Transition transition) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo16clone = transition.mo16clone();
        sceneChangeSetup(viewGroup, mo16clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo16clone);
    }
