...
public class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if ("fragment".equals(str)) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0240R.styleable.Fragment);
            if (attributeValue == null) {
                attributeValue = obtainStyledAttributes.getString(C0240R.styleable.Fragment_android_name);
            }
            int resourceId = obtainStyledAttributes.getResourceId(C0240R.styleable.Fragment_android_id, -1);
            String string = obtainStyledAttributes.getString(C0240R.styleable.Fragment_android_tag);
