...
public class FragmentStateManager {
    ...
    public int computeMaxState() {
        ...
        int i2 = C02651.$SwitchMap$androidx$lifecycle$Lifecycle$State[this.mFragment.mMaxState.ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
                if (i2 == 3) {
                    return Math.min(i, 1);
    ...
    public void ensureInflatedView() {
        if (this.mFragment.mFromLayout && this.mFragment.mInLayout && !this.mFragment.mPerformedCreateView) {
            ...
            if (this.mFragment.mView != null) {
                ...
                this.mFragment.mView.setTag(C0240R.C0243id.fragment_container_view_tag, this.mFragment);
