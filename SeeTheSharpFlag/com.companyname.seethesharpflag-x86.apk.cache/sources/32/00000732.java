...
import androidx.swiperefreshlayout.C0391R;
...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(C0391R.styleable.SwipeRefreshLayout);
        this.mBackgroundColor = obtainStyledAttributes.getColor(C0391R.styleable.f31xaa980688, DEFAULT_BACKGROUND_COLOR);
