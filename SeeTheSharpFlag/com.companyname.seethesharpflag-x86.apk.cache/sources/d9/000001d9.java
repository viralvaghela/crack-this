    ...
    */
    public void loadFromAttributes(android.util.AttributeSet r11, int r12) {
        /*
            ...
            int[] r1 = androidx.appcompat.C0034R.styleable.CompoundButton
            r2 = 0
            ...
            int[] r5 = androidx.appcompat.C0034R.styleable.CompoundButton
            ...
            int r11 = androidx.appcompat.C0034R.styleable.CompoundButton_buttonCompat     // Catch: java.lang.Throwable -> L8e
        ...
        L3f:
            if (r11 != 0) goto L5e
            int r11 = androidx.appcompat.C0034R.styleable.CompoundButton_android_button     // Catch: java.lang.Throwable -> L8e
            boolean r11 = r0.hasValue(r11)     // Catch: java.lang.Throwable -> L8e
            if (r11 == 0) goto L5e
            int r11 = androidx.appcompat.C0034R.styleable.CompoundButton_android_button     // Catch: java.lang.Throwable -> L8e
            int r11 = r0.getResourceId(r11, r2)     // Catch: java.lang.Throwable -> L8e
        ...
        L5e:
            int r11 = androidx.appcompat.C0034R.styleable.CompoundButton_buttonTint     // Catch: java.lang.Throwable -> L8e
            boolean r11 = r0.hasValue(r11)     // Catch: java.lang.Throwable -> L8e
            if (r11 == 0) goto L71
            android.widget.CompoundButton r11 = r10.mView     // Catch: java.lang.Throwable -> L8e
            int r12 = androidx.appcompat.C0034R.styleable.CompoundButton_buttonTint     // Catch: java.lang.Throwable -> L8e
        ...
        L71:
            int r11 = androidx.appcompat.C0034R.styleable.CompoundButton_buttonTintMode     // Catch: java.lang.Throwable -> L8e
            boolean r11 = r0.hasValue(r11)     // Catch: java.lang.Throwable -> L8e
            if (r11 == 0) goto L8a
            android.widget.CompoundButton r11 = r10.mView     // Catch: java.lang.Throwable -> L8e
            int r12 = androidx.appcompat.C0034R.styleable.CompoundButton_buttonTintMode     // Catch: java.lang.Throwable -> L8e
            r1 = -1
