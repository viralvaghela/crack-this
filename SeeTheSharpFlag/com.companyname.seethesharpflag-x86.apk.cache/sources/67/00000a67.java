...
public class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public void initialize() {
        float dimensionPixelOffset = this.context.getResources().getDimensionPixelOffset(C0492R.dimen.mtrl_shape_corner_size_small_component);
        float dimensionPixelOffset2 = this.context.getResources().getDimensionPixelOffset(C0492R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        int dimensionPixelOffset3 = this.context.getResources().getDimensionPixelOffset(C0492R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
        ...
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, IS_LOLLIPOP ? C0492R.C0494drawable.mtrl_dropdown_arrow : C0492R.C0494drawable.mtrl_ic_arrow_drop_down));
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C0492R.string.exposed_dropdown_menu_content_description));
    ...
    public void addRippleEffect(AutoCompleteTextView autoCompleteTextView) {
        ...
        int color = MaterialColors.getColor(autoCompleteTextView, C0492R.attr.colorControlHighlight);
    ...
    private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView autoCompleteTextView, int i, int[][] iArr, MaterialShapeDrawable materialShapeDrawable) {
        ...
        int color = MaterialColors.getColor(autoCompleteTextView, C0492R.attr.colorSurface);
