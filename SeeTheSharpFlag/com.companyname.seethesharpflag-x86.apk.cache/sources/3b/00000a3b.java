...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0492R.styleable.SnackbarLayout);
        this.maxWidth = obtainStyledAttributes.getDimensionPixelSize(C0492R.styleable.SnackbarLayout_android_maxWidth, -1);
        this.maxInlineActionWidth = obtainStyledAttributes.getDimensionPixelSize(C0492R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
    ...
    protected void onFinishInflate() {
        ...
        this.messageView = (TextView) findViewById(C0492R.C0495id.snackbar_text);
        this.actionView = (Button) findViewById(C0492R.C0495id.snackbar_action);
    }
    ...
    public void updateActionTextColorAlphaIfNeeded(float f) {
        if (f != 1.0f) {
            this.actionView.setTextColor(MaterialColors.layer(MaterialColors.getColor(this, C0492R.attr.colorSurface), this.actionView.getCurrentTextColor(), f));
        }
    }
    ...
    */
    protected void onMeasure(int r8, int r9) {
        ...
        L18:
            ...
            int r1 = com.google.android.material.C0492R.dimen.design_snackbar_padding_vertical_2lines
            int r0 = r0.getDimensionPixelSize(r1)
            android.content.res.Resources r1 = r7.getResources()
            int r2 = com.google.android.material.C0492R.dimen.design_snackbar_padding_vertical
