...
public final class NotificationManagerCompat {
    ...
    public static class NotifyTask implements Task {
        ...
        public String toString() {
            return "NotifyTask[packageName:" + this.packageName + ", id:" + this.f17id + ", tag:" + this.tag + "]";
        }
    }
    ...
    public static class CancelTask implements Task {
        ...
        public String toString() {
            return "CancelTask[packageName:" + this.packageName + ", id:" + this.f16id + ", tag:" + this.tag + ", all:" + this.all + "]";
        }
    }
}