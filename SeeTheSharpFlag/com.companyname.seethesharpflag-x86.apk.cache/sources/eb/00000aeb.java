...
public class MaterialContainerTransformSharedElementCallback extends SharedElementCallback {
    ...
    public View onCreateSnapshotView(Context context, Parcelable parcelable) {
        ...
        if (onCreateSnapshotView != null && (weakReference = capturedSharedElement) != null && this.shapeProvider != null && (view = weakReference.get()) != null && (provideShape = this.shapeProvider.provideShape(view)) != null) {
            onCreateSnapshotView.setTag(C0492R.C0495id.mtrl_motion_snapshot_view, provideShape);
        }
    ...
    public void onSharedElementStart(List<String> list, List<View> list2, List<View> list3) {
        if (!list2.isEmpty() && !list3.isEmpty()) {
            list2.get(0).setTag(C0492R.C0495id.mtrl_motion_snapshot_view, list3.get(0));
        }
    ...
    public void onSharedElementEnd(List<String> list, List<View> list2, List<View> list3) {
        if (!list2.isEmpty() && (list2.get(0).getTag(C0492R.C0495id.mtrl_motion_snapshot_view) instanceof View)) {
            list2.get(0).setTag(C0492R.C0495id.mtrl_motion_snapshot_view, null);
        }
