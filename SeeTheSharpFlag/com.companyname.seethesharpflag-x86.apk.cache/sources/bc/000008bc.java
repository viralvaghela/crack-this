...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C0492R.layout.design_bottom_navigation_item, (ViewGroup) this, true);
        setBackgroundResource(C0492R.C0494drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C0492R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0492R.C0495id.icon);
        TextView textView = (TextView) findViewById(C0492R.C0495id.smallLabel);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C0492R.C0495id.largeLabel);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        wrap.setRoleDescription(getResources().getString(C0492R.string.item_view_role_description));
    }
