...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C0492R.style.Widget_Design_FloatingActionButton;
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0492R.attr.floatingActionButtonStyle);
    }
    ...
    */
    ...
    private int getSizeDimension(int i) {
        ...
        if (i != -1) {
            if (i == 1) {
                return resources.getDimensionPixelSize(C0492R.dimen.design_fab_size_mini);
            }
            return resources.getDimensionPixelSize(C0492R.dimen.design_fab_size_normal);
    ...
    protected static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public BaseBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0492R.styleable.FloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = obtainStyledAttributes.getBoolean(C0492R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, AUTO_HIDE_DEFAULT);
