...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0492R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C0492R.attr.snackbarButtonStyle, C0492R.attr.snackbarTextViewStyle};
    ...
    public static Snackbar make(View view, CharSequence charSequence, int i) {
        ...
        SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(findSuitableParent.getContext()).inflate(hasSnackbarContentStyleAttrs(findSuitableParent.getContext()) ? C0492R.layout.mtrl_layout_snackbar_include : C0492R.layout.design_layout_snackbar_include, findSuitableParent, false);
