...
public class TabLayout extends HorizontalScrollView {
    ...
    ViewPager viewPager;
    private static final int DEF_STYLE_RES = C0492R.style.Widget_Design_TabLayout;
    ...
    public TabLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0492R.attr.tabStyle);
    }
    ...
    */
    ...
    public final class TabView extends LinearLayout {
        ...
        private void inflateAndAddDefaultIconView() {
            ...
            ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(C0492R.layout.design_layout_tab_icon, (ViewGroup) frameLayout, false);
        ...
        private void inflateAndAddDefaultTextView() {
            ...
            TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C0492R.layout.design_layout_tab_text, (ViewGroup) frameLayout, false);
