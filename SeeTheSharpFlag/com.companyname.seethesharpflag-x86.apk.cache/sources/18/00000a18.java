...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    static {
        ...
        SNACKBAR_STYLE_ATTR = new int[]{C0492R.attr.snackbarStyle};
    ...
    protected int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C0492R.layout.mtrl_layout_snackbar : C0492R.layout.design_layout_snackbar;
    }
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        public SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, C0492R.styleable.SnackbarLayout);
            if (obtainStyledAttributes.hasValue(C0492R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, obtainStyledAttributes.getDimensionPixelSize(C0492R.styleable.SnackbarLayout_elevation, 0));
            }
            this.animationMode = obtainStyledAttributes.getInt(C0492R.styleable.SnackbarLayout_animationMode, 0);
            this.backgroundOverlayColorAlpha = obtainStyledAttributes.getFloat(C0492R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            setBackgroundTintList(MaterialResources.getColorStateList(context2, obtainStyledAttributes, C0492R.styleable.SnackbarLayout_backgroundTint));
            setBackgroundTintMode(ViewUtils.parseTintMode(obtainStyledAttributes.getInt(C0492R.styleable.SnackbarLayout_backgroundTintMode, -1), PorterDuff.Mode.SRC_IN));
            this.actionTextColorAlpha = obtainStyledAttributes.getFloat(C0492R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
            obtainStyledAttributes.recycle();
        ...
        private Drawable createThemedBackground() {
            float dimension = getResources().getDimension(C0492R.dimen.mtrl_snackbar_background_corner_radius);
            GradientDrawable gradientDrawable = new GradientDrawable();
            gradientDrawable.setShape(0);
            gradientDrawable.setCornerRadius(dimension);
            gradientDrawable.setColor(MaterialColors.layer(this, C0492R.attr.colorSurface, C0492R.attr.colorOnSurface, getBackgroundOverlayColorAlpha()));
