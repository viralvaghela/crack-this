...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    private static final int DEF_STYLE_RES = C0492R.style.Widget_MaterialComponents_Chip_Action;
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0492R.attr.chipStyle);
    }
    ...
    */
    public Chip(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            r6.setElevation(r0)
            int[] r2 = com.google.android.material.C0492R.styleable.Chip
            r0 = 0
            int[] r5 = new int[r0]
            r0 = r8
            r1 = r9
            ...
            r0 = 23
            if (r10 >= r0) goto L51
            int r10 = com.google.android.material.C0492R.styleable.Chip_android_textColor
            ...
            r7.setTextColor(r8)
        L51:
            int r8 = com.google.android.material.C0492R.styleable.Chip_shapeAppearance
    ...
    private void initMinTouchTarget(Context context, AttributeSet attributeSet, int i) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C0492R.styleable.Chip, i, DEF_STYLE_RES, new int[0]);
        this.ensureMinTouchTargetSize = obtainStyledAttributes.getBoolean(C0492R.styleable.Chip_ensureMinTouchTargetSize, false);
        this.minTouchTargetSize = (int) Math.ceil(obtainStyledAttributes.getDimension(C0492R.styleable.Chip_chipMinTouchTargetSize, (float) Math.ceil(ViewUtils.dpToPx(getContext(), 48))));
        ...
        protected void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            if (i == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int i2 = C0492R.string.mtrl_chip_close_icon_content_description;
